...
m = {
  ...
  -- New md-helper remaps
  C = { md.generate_toc, "Create TOC" },    -- Shifted to capital C to avoid conflict with PDF conversion
  i = { md.create_image, "Insert Image" },  -- Replaces your "Embed image at mouse"
  l = { md.create_link, "Insert Link" },
  m = { md.create_table, "Create table" },  -- Maps to md.create_table
},
